namespace pxsim.visuals {
	...
	<g id="TOUCH_PINS">
		...
		<path id="TOUCH_P3" class="st8" d="M533.2,235.2c-1.5-0.5-3.2-0.9-4.8-1.2c-0.3,0-0.6-0.1-0.9-0.1c-1.4-0.2-2.8-0.3-4.2-0.3
		...
		<path id="TOUCH_P2" class="st8" d="M424.4,481.4c-0.1-0.4-0.2-0.8-0.3-1.2c-0.3-1.3-0.8-2.6-1.3-3.8c-0.1-0.3-0.2-0.6-0.4-0.8
		...
		<path id="TOUCH_P1" class="st8" d="M166.6,480.8c-0.2-0.8-0.4-1.5-0.7-2.2c0-0.1,0-0.2-0.1-0.2c-0.2-0.6-0.5-1.3-0.7-1.9
		...
		<path id="TOUCH_P0" class="st8" d="M6.4,233.4c-0.5,0-1.1,0-1.6,0s-1,0-1.5,0.1c-2,0.2-3.9,0.5-5.7,1.1
